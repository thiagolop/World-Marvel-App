...
class Data {
  ...
  late final List<ResultsSeries> results;
  ...
  Data.fromJson(Map<String, dynamic> json){
    ...
    total = json['total'];
    count = json['count'];
    results = List.from(json['results']).map((e)=>ResultsSeries.fromJson(e)).toList();
  }
...
class ResultsSeries {
  ...
  ResultsSeries.fromJson(Map<String, dynamic> json){
    id = json['id'];
    title = json['title'];
    description = null;

...
import 'package:marvelapk01/core/pages/character/widgets/stories_widget.dart';
              ...
              child: Column(
                children: [
                  ...
                  ExpansionTile(title: AdditionalInformationWidget(title: 'Stories', description: '${widget.character.stories.available}'), children: [
                    const SizedBox(height: 16),
                    StoriesWidget(characterID: widget.character.id),
                  ]),
                  const SizedBox(height: 24),
                  ExpansionTile(title: AdditionalInformationWidget(title: 'Events', description: '${widget.character.events.available}'), children: [
                    const SizedBox(height: 16),
                    EventsWidget(characterID: widget.character.id),
                  ]),
                  const SizedBox(height: 24),
